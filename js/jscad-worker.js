            ...
            if (data.cmd == 'rendered') {
                if (data.objects && data.objects.length) {
                    ...
                    for (var i = 0; i < data.objects.length; i++) {
                        ...
                        if (o['class'] == 'CSG') { objects.push(csg.CSG.fromCompactBinary(o)); }
                        if (o['class'] == 'CAG') { objects.push(csg.CAG.fromCompactBinary(o)); }
                    }
        ...
        if (data.cmd == 'render') {
            ...
            if (typeof(main) == 'function') {
                ...
                for (var i = 0; i < results.length; i++) {
                    var o = results[i];
                    if (o instanceof csg.CAG || o instanceof csg.CSG) {
