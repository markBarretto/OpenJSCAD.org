            ...
            if ('source' in data) {
                ...
                switch (e) {
                    ...
                    case 'gcode':
                        ...
                        r.source = r.converted = OpenScad.parseGCode(data.source, data.filename);
                        break;
                    case 'obj':
                        //            importScripts(r.baseurl+'csg.js',r.baseurl+'openjscad.js',r.baseurl+'openscad.js');
                        r.source = r.converted = OpenScad.parseOBJ(data.source, data.filename);
                        break;
                    case 'scad':
                    ...
                    case 'stl':
                        // importScripts(r.baseurl+'csg.js',r.baseurl+'openjscad.js',r.baseurl+'openscad.js');
                        r.source = r.converted = OpenScad.parseSTL(data.source, data.filename);
                        break;
                    case 'js':
